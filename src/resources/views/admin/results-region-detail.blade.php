...
<head>
  ...
  <title>{{$quiz->quiz_name}}, {{$region->name}}</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{$quiz->quiz_name}} {{ __("в разрезе школ") }}: {{$region->name}}:</h1>
            <h12></h2>
          </div>
          <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
                        <div class="row">
                            ...
                            <div class="info-box bg-light">
                                <div class="info-box-content">
                                <span class="info-box-text text-center text-muted">{{ __("Средний балл") }}</span>
                                <span class="info-box-number text-center text-muted mb-0">{{round($quiz->respondent_result()->get()->avg('scope'),2)}}</span>
                                </div>
                            </div>
                            </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a href="/admin/results/school/{{$school['school_id']}}/{{$quiz->id}}">{{ __("Подробно") }}</a> </td>
                  </tr>
                  @endforeach		
                  </tbody>
                  <tfoot>
